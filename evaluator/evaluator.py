...
class Evaluator(object):
    ...
    def evaluate(self, dataobject: DataStruct):
        ...
        result_dict['AF@20'] = result_dict['ndcg@20']/(result_dict['c-fair']*result_dict['P-Fair-CV@20'])
        #result_dict['af_new@20'] = result_dict['ndcg@20']*100/(result_dict['eo']*100*result_dict['P-Fair-CV@20'])
        return result_dict
